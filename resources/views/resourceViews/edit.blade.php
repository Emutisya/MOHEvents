...
<head>
  ...
  <title>Resources Registration</title>
  ...
  <link href="{{ asset('css/argon.css?v=1.2.0') }}" rel="stylesheet" type="text/css" >
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="/events">
                ...
                <span class="nav-link-text">Resources Registration</span>
              </a>
            </li>
